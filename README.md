...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uzuk6d8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uzuk6d8.containers.anotherwebservice.com/
...
```
git clone git@github.com:danielhbright/container-uzuk6d8.git
cd container-uzuk6d8
```
...
```
docker attach container-uzuk6d8
```
